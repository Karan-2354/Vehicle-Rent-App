...
public class CarViewDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car_view_detail);
        ...
        if(bundle!=null)
        {
            Glide.with(this).load(bundle.getString("Car_Image")).into(carView_image);
            carView_name.setText(bundle.getString("Car_Name"));
            carView_desc.setText(bundle.getString("Car_Desc"));
            carView_location.setText(bundle.getString("Car_Location"));
            carView_price.setText(bundle.getString("Car_Price"));
            AdminNo=bundle.getString("AdminNo");
            UserNo=bundle.getString("UserNo");
            uri= Uri.parse(bundle.getString("Car_Image"));
        }
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                savedata();
                Intent intent = new Intent(CarViewDetail.this, HomeUser.class);
    ...
    public void savedata()
    {
        ...
        FirebaseDatabase.getInstance().getReference("Booking").child("CAR").child(AdminNo).child(date)
                .setValue(car).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(CarViewDetail.this,"Saved Successful",Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(CarViewDetail.this,e.getMessage().toString(),Toast.LENGTH_LONG).show();
                    }
                });
