...
public class BikeViewDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bike_view_detail);
        ...
        if(bundle!=null)
        {
            Glide.with(this).load(bundle.getString("Bike_Image")).into(carView_image);
            carView_name.setText(bundle.getString("Bike_Name"));
            carView_desc.setText(bundle.getString("Bike_Desc"));
            carView_location.setText(bundle.getString("Bike_Location"));
            carView_price.setText(bundle.getString("Bike_Price"));
            AdminNo=bundle.getString("AdminNo");
            UserNo=bundle.getString("UserNo");
            uri= Uri.parse(bundle.getString("Bike_Image"));
        }
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                savedata();
                Intent intent = new Intent(BikeViewDetail.this, HomeUser.class);
    ...
    public void savedata()
    {
        ...
        FirebaseDatabase.getInstance().getReference("Booking").child("BIKE").child(AdminNo).child(date)
                .setValue(car).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(BikeViewDetail.this,"Saved Successful",Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(BikeViewDetail.this,e.getMessage().toString(),Toast.LENGTH_LONG).show();
                    }
                });
