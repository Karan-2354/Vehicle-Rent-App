...
public class ScooterViewDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scooter_view_detail);
        ...
        if(bundle!=null)
        {
            Glide.with(this).load(bundle.getString("Scooter_Image")).into(carView_image);
            carView_name.setText(bundle.getString("Scooter_Name"));
            carView_desc.setText(bundle.getString("Scooter_Desc"));
            carView_location.setText(bundle.getString("Scooter_Location"));
            carView_price.setText(bundle.getString("Scooter_Price"));
            AdminNo=bundle.getString("AdminNo");
            UserNo=bundle.getString("UserNo");
            uri= Uri.parse(bundle.getString("Scooter_Image"));
        }
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                savedata();
                Intent intent = new Intent(ScooterViewDetail.this, HomeUser.class);
    ...
    public void savedata()
    {
        ...
        FirebaseDatabase.getInstance().getReference("Booking").child("SCOOTER").child(AdminNo).child(date)
                .setValue(car).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(ScooterViewDetail.this,"Saved Successful",Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ScooterViewDetail.this,e.getMessage().toString(),Toast.LENGTH_LONG).show();
                    }
                });
    }
}